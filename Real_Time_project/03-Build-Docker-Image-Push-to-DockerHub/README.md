...
> **Important Note:** In the commands below, wherever you see `raghib1992`, replace it with your Docker Hub username.
...
> **Note:** Docker Hub sign-in is not required for downloading public images. For example, the Docker image `raghib1992/mynginx` is a public image.
...
# Example:
docker build -t raghib1992/kalyan/app1:v1 .
...
# Example:
docker run --name mynginx1 -p 8090:80 -d raghib1992/kalyan/app1:v1
...
docker tag app1:v1 raghib1992/kalyan/app1:v1

# Push the Docker image to Docker Hub
docker push YOUR_DOCKER_USERNAME/mynginx-custom:v1

# Example with 'stacksimplify':
docker push raghib1992/kalyan/app1:v1
